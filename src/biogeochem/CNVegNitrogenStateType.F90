...
#include "shr_assert.h"
  ...
  type, public :: cnveg_nitrogenstate_type
     ...
     real(r8), pointer :: deadstemn_soy_patch      (:) ! (gN/m2) dead stem N at the start of season (added by O.Dombrowski)
     real(r8), pointer :: deadstemn_storage_soy_patch (:) ! (gN/m2) dead stem N at the start of season (added by O.Dombrowski)
